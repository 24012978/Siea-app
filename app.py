...
def login_page():
 ...
 h+='</div>'
 h+='<div class=support-info style="border-left:3px solid #a855f7; background:rgba(168,85,247,0.08); padding:15px; border-radius:12px; text-align:center;">'
h+='<b style="color:#a855f7; font-size:15px;">SUSCRIPCION</b>'
h+='<p>Acceso ilimitado a todas las materias, reactivos y evaluaciones sin restricciones.</p>'
h+='<a href="https://wa.me/528110290152?text=Hola%2C%20quiero%20pagar%20mi%20suscripcion%20SIEA%20de%20%2449%20MXN" target="_blank" style="display:block; background:#a855f7; color:white; padding:12px; border-radius:10px; text-decoration:none; font-weight:bold; margin-top:10px; box-shadow: 0 0 15px rgba(168,85,247,0.4);">🔓 PAGAR SUSCRIPCION - $49 MXN</a>'
h+='</div>'
 h+='</div>'
 h+='</div>'
