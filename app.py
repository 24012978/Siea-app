...
def login_page():
 ...
 h+='<input type="hidden" name="item_name" value="Suscripción S.I.E.A. Premium">'
 ...
 h+='<button type="submit" class="btn btn-paypal">🔒 PAGAR SUSCRIPCION - $9.99 USD</button>'
 h+='</form>'
 h+='</div>'
 h+='</div>'
 h+='</div>'
